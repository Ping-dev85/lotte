...
sojaeji.prototype = {
    ...
    '경남': ['창원시 마산합포구', '창원시 마산회원구', '창원시 성산구', '창원시 의창구', '창원시 진해구', '거제시', '김해시', '밀양시', '사천시', '양산시', '진주시', '통영시', '거창군', '고성군', '남해군', '산청군', '의령군', '창녕군', '하동군', '함안군', '함양군', '합천군'],
    ...
    '경남->창원시 마산합포구': ['구산면', '진동면', '진북면', '진전면', '현동', '가포동', '월영동', '문화동', '반월중앙동', '완월동', '자산동', '교방동', '노산동', '오동동', '합포동', '산호동'],
    ...
    '경남->창원시 진해구': ['중앙동', '태평동', '충무동', '여좌동', '태백동', '경화동', '병암동', '석동', '이동', '자은동', '덕산동', '풍호동', '웅천동', '웅동1동', '웅동2동'],
    ...
    '충북->청주시 상당구': ['남성면', '미원면', '가덕면', '남일면', '문의면', '중앙동', '성안동', '탑대성동', '영운동', '금천동', '용담명암산성동', '용암1동', '용암2동'],
    '충북->청주시 흥덕구': ['오송읍', '강내면', '옥산면', '운천신봉동', '복대1동', '복대2동', '가경동', '봉명1동', '봉명2송정동', '강서1동', '강서2동'],
    '충북->증평군': ['도안면', '증평읍'],
